...
- `dist/Arkinity Setup 1.0.0.exe`
- `dist/win-unpacked/Arkinity.exe`
...
├── flatpak/
│   ├── com.arkinity.launcher.yml  # Flatpak manifest
│   ├── com.arkinity.launcher.desktop
│   ├── com.arkinity.launcher.metainfo.xml
│   ├── com.arkinity.launcher.svg
│   └── run-arkinity.sh            # Flatpak entrypoint wrapper
